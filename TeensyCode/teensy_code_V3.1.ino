...
#define ID_CUTOFF8_POSITION 206
...
#define ID_PB1_ADSR1_AMOUNT 030
#define ID_PB1_ADSR2_AMOUNT 031
#define ID_PB1_LFO1_AMOUNT 130
#define ID_PB1_LFO2_AMOUNT 131

#define ID_PWM1_ADSR1_AMOUNT 034
#define ID_PWM1_ADSR2_AMOUNT 035
#define ID_PWM1_LFO1_AMOUNT 134
#define ID_PWM1_LFO2_AMOUNT 135

#define ID_SHAPE1_ADSR1_AMOUNT 038
#define ID_SHAPE1_ADSR2_AMOUNT 039
#define ID_SHAPE1_LFO1_AMOUNT 138
#define ID_SHAPE1_LFO2_AMOUNT 139                 

#define ID_LVL1_ADSR1_AMOUNT 042
#define ID_LVL1_ADSR2_AMOUNT 043
#define ID_LVL1_LFO1_AMOUNT 142
#define ID_LVL1_LFO2_AMOUNT 143

#define ID_PB2_ADSR1_AMOUNT 046
#define ID_PB2_ADSR2_AMOUNT 047
#define ID_PB2_LFO1_AMOUNT 146
#define ID_PB2_LFO2_AMOUNT 147

#define ID_PWM2_ADSR1_AMOUNT 050
#define ID_PWM2_ADSR2_AMOUNT 051
#define ID_PWM2_LFO1_AMOUNT 150
#define ID_PWM2_LFO2_AMOUNT 151

#define ID_SHAPE2_ADSR1_AMOUNT 054
#define ID_SHAPE2_ADSR2_AMOUNT 055
#define ID_SHAPE2_LFO1_AMOUNT 154
#define ID_SHAPE2_LFO2_AMOUNT 155

#define ID_LVL2_ADSR1_AMOUNT 058
#define ID_LVL2_ADSR2_AMOUNT 059
#define ID_LVL2_LFO1_AMOUNT 158
#define ID_LVL2_LFO2_AMOUNT 159

#define ID_FM_ADSR1_AMOUNT 062
#define ID_FM_ADSR2_AMOUNT 063
#define ID_FM_LFO1_AMOUNT 162
#define ID_FM_LFO2_AMOUNT 163

#define ID_DETUNE_ADSR1_AMOUNT 064
#define ID_DETUNE_ADSR2_AMOUNT 065
#define ID_DETUNE_LFO1_AMOUNT 164
#define ID_DETUNE_LFO2_AMOUNT 165

#define ID_CUTOFF_ADSR1_AMOUNT 066
#define ID_CUTOFF_ADSR2_AMOUNT 067
#define ID_CUTOFF_LFO1_AMOUNT 166
#define ID_CUTOFF_LFO2_AMOUNT 167

#define ID_RES_ADSR1_AMOUNT 070
#define ID_RES_ADSR2_AMOUNT 071
#define ID_RES_LFO1_AMOUNT 170
#define ID_RES_LFO2_AMOUNT 171

#define ID_DRIVE_ADSR1_AMOUNT 074
#define ID_DRIVE_ADSR2_AMOUNT 075
...
int             PB1=0;  //initialise integers to write to DACs
int             PB2=0;
int             PWM1=0;
int             PWM2=0;
int             CUTOFF=0;
...
//ADD MORE OF THESE
float           volume_position = 0.; //range 0 to 1 
...
float           VCA1_ADSR1_AMOUNT = 0.;
float           VCA1_ADSR2_AMOUNT = 0.;
float           VCA1_LFO1_AMOUNT = 0.;
float           VCA1_LFO2_AMOUNT = 0.;

float           VCA2_ADSR1_AMOUNT = 0.;
float           VCA2_ADSR2_AMOUNT = 0.;
float           VCA2_LFO1_AMOUNT = 0.;
float           VCA2_LFO2_AMOUNT = 0.;

float           VCA3_ADSR1_AMOUNT = 0.;
float           VCA3_ADSR2_AMOUNT = 0.;
float           VCA3_LFO1_AMOUNT = 0.;
float           VCA3_LFO2_AMOUNT = 0.;

float           VCA4_ADSR1_AMOUNT = 0.;
float           VCA4_ADSR2_AMOUNT = 0.;
float           VCA4_LFO1_AMOUNT = 0.;
float           VCA4_LFO2_AMOUNT = 0.;

float           VCA5_ADSR1_AMOUNT = 0.;
float           VCA5_ADSR2_AMOUNT = 0.;
float           VCA5_LFO1_AMOUNT = 0.;
float           VCA5_LFO2_AMOUNT = 0.;

float           VCA6_ADSR1_AMOUNT = 0.;
float           VCA6_ADSR2_AMOUNT = 0.;
float           VCA6_LFO1_AMOUNT = 0.;
float           VCA6_LFO2_AMOUNT = 0.;
...
void loop() {
    ...
    VCA1=int(drive_position*vca1_position*(adsr1_sample*VCA1_ADSR1_AMOUNT + adsr2_sample*VCA1_ADSR2_AMOUNT + lfo1_sample*VCA1_LFO1_AMOUNT + lfo2_sample*VCA1_LFO2_AMOUNT) + 2048); //all modulations weighted and added together 
    if (VCA1 > 4095){
        VCA1=4095;
    }
    ...
    VCA2=int(drive_position*vca2_position*(adsr1_sample*VCA2_ADSR1_AMOUNT + adsr2_sample*VCA2_ADSR2_AMOUNT + lfo1_sample*VCA2_LFO1_AMOUNT + lfo2_sample*VCA2_LFO2_AMOUNT) + 2048); //all modulations weighted and added together 
    if (VCA2 > 4095){
        VCA2=4095;
    }
    ...
    VCA3=int(drive_position*vca3_position*(adsr1_sample*VCA3_ADSR1_AMOUNT + adsr2_sample*VCA3_ADSR2_AMOUNT + lfo1_sample*VCA3_LFO1_AMOUNT + lfo2_sample*VCA3_LFO2_AMOUNT) + 2048); //all modulations weighted and added together 
    if (VCA3 > 4095){
        VCA3=4095;
    }
    ...
    VCA4=int(drive_position*vca4_position*(adsr1_sample*VCA4_ADSR1_AMOUNT + adsr2_sample*VCA4_ADSR2_AMOUNT + lfo1_sample*VCA4_LFO1_AMOUNT + lfo2_sample*VCA4_LFO2_AMOUNT) + 2048); //all modulations weighted and added together 
    if (VCA4 > 4095){
        VCA4=4095;
    }
    ...
    VCA5=int(drive_position*vca5_position*(adsr1_sample*VCA5_ADSR1_AMOUNT + adsr2_sample*VCA5_ADSR2_AMOUNT + lfo1_sample*VCA5_LFO1_AMOUNT + lfo2_sample*VCA5_LFO2_AMOUNT) + 2048); //all modulations weighted and added together 
    if (VCA5 > 4095){
        VCA5=4095;
    }
    ...
    VCA6=int(drive_position*vca6_position*(adsr1_sample*VCA6_ADSR1_AMOUNT + adsr2_sample*VCA6_ADSR2_AMOUNT + lfo1_sample*VCA6_LFO1_AMOUNT + lfo2_sample*VCA6_LFO2_AMOUNT) + 2048); //all modulations weighted and added together 
    if (VCA6 > 4095){
        VCA6=4095;
    }
