...
//    myDacA.analogWrite(1,mV);
   ...
   // myDacB.analogWrite(1,lfo1.getWave(t));
    ...
    myDacD.analogWrite(0,4095);
    myDacD.analogWrite(1,4095);
    myDacE.analogWrite(0,4095);
    myDacE.analogWrite(1,4095);
    myDacF.analogWrite(0,4095);
    myDacF.analogWrite(1,4095);
    myDacG.analogWrite(0,4095);
    myDacG.analogWrite(1,4095);
    myDacH.analogWrite(0,4095);
    myDacH.analogWrite(1,4095);
